...
/**
 * STEP 12
 * Ini untuk melakukan pengecekan apakah ada perubahan list note.
...
/**
 * Setelah menyiapkan kelas helper, Anda perlu membuat menu yang
 * akan digunakan di NoteAddUpdateActivity.
 * --- membuat menu form adalah STEP 13
 *
 * **/