package com.cahyadesthian.thesettingpreference
...
class MyPreferenceFragment : PreferenceFragmentCompat(),
    ...
    private lateinit var isLoveMcPreference: CheckBoxPreference
    ...
    /*
    * untuk memanggil kompoen seperti
    * EditTextPreference dan CheckBoxPreference
    * */
    private fun init() {
        ...
        isLoveMcPreference = findPreference<CheckBoxPreference>(LOVE) as CheckBoxPreference
    ...
    private fun setSummaries() {
        ...
        isLoveMcPreference.isChecked = sh.getBoolean(LOVE, false)

    }


    /*
    * Kode onResume dan onpause
    * digunakan untuk me-register ketika aplikasi dibuka dan me-unregister ketika aplikasi ditutup.
    ...
    * */
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        if(key == LOVE) isLoveMcPreference.isChecked = sharedPreferences?.getBoolean(LOVE,false) ?: false
