...
import com.cahyadesthian.deepnavjahat.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainBinding.btnOpenDetailMainUI.setOnClickListener(this)
    ...
    override fun onClick(v: View) {
        if(v.id == R.id.btn_open_detail_mainUI) {
